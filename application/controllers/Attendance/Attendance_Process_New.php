...
//                        var_dump($EmpNo.$FromDate);die;
                        $SH['SH'] = $this->Db_model->getfilteredData("select ID_roster,EmpNo,ShiftCode,ShType,ShiftDay,Day_Type,FDate,FTime,TDate,TTime,GracePrd from tbl_individual_roster where EmpNo='$EmpNo' && FDate='$FromDate'");
