...
<div style="border-radius: 20px; " class="static-sidebar-wrapper sidebar-default">
    <div class="static-sidebar">
        <div class="sidebar">
            <div class="" id="widget-welcomebox" style="background-color: #3a869f; color: white">
                    ...
                    <ul class="acc-menu">
                        ...
                        <?php if ($currentUser[0]->master_data == 1): ?>
                            ...
                            <?php if ($currentUser[0]->master_data == 1): ?>
                                ...
                                <?php if ($currentUser[0]->designation == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Master/Designation_2/">DESIGNATION-2</a></li>
                                <?php endif; ?>
                        ...
                        <?php if ($currentUser[0]->Attendance_Report == 1): ?>
                            ...
                            <?php if ($currentUser[0]->Attendance_Report == 1): ?>
                                ...
                                <?php if ($currentUser[0]->in_out_report == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Reports/Attendance/Report_Attendance_In_Out_Row">IN OUT ROW</a></li>
                                <?php endif; ?>
