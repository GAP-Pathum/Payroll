...
/*        background: url(<?php echo base_url(); ?>assets/images/company/header-left.svg) left top no-repeat, linear-gradient(to bottom, #660066 0%, #ffccff 100%);
    background-size: 83%;*/
...
//                    echo $logo_hr;
                ...
                <img style="width: 350px; height: 122px;" src="<?php base_url(); ?>
  ...
  box-shadow: 1px 3px 5px 5px #ffccff;">
                        <div class="panel-heading "><h2 style="color: #0079c4">Login To Payroll System</h2></div>
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" id="frmLogin" name="frmLogin" action="<?php echo base_url() ?>login/verifyUser" method="POST">
                                ...
                                <div id="divmessage" class=""> <div id="spnmessage"> </div></div>
